...
public:
    ...
    //     // cout << "===============================\n";
    //     // cout << "Booking room information: " << endl;
    //     // cout << "===============================\n";
    //     auto result = find_if(
    //             roomLists.begin(),
    //             roomLists.end(),
    ...
    //                 if (rooms.getAvailabilityString() == "Booked"){
    //                     table.add_row(
    //                         {
    //                         rooms.name,
    //                         to_string(rooms.phoneNum),
    //                         rooms.checkInDate,
    //                         to_string(rooms.getRoomId()),
    //                         rooms.getRoomType(),
    //                         rooms.getEquipments(),
    //                         priceStr,
    //                         });
        ...
        else if (name == "guest" && password == "guest123")
        {
            ...
            do
            {
                ...
                case 1:
                {
                    ...
                    Guest gs1;
                    gs1.displayRoomForGuest(roomLists);
                }
                break;
                case 2:
                {
                    ...
                    do
                    {
                        ...
                        case 1:
                        {
                            ...
                            {
                                Guest gs1;
                                gs1.sortRoomByIdAsc(roomLists);
                            }
                            break;
                            case 2:
                            {
                                Guest gs1;
                                gs1.sortRoomByIdDsc(roomLists);
                            }
                            break;
                            case 3:
                                break;
                        ...
                        case 2:
                        {
                            ...
                            {
                                Guest gs1;
                                gs1.sortRoomByPriceAsc(roomLists);
                            }
                            break;
                            case 2:
                            {
                                Guest gs1;
                                gs1.sortRoomByPriceDsc(roomLists);
                            }
                            break;
                            case 3:
                                break;
                ...
                case 4:
                {
                    printLabel("Search Room By ID");
                    Guest gs;
                    gs.searchGuestRoomById(roomLists);
                }
                break;
                case 5:
                {
